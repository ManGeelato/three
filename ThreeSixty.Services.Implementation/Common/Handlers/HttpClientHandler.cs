...
namespace ThreeSixty.Services.Implementation.Common.Handlers
{
            ...
            where TResult : class where TRequest : class
        {
            ...
            try
            {
                ...
                var response = method switch
                {
                    ...
                    Enums.MethodType.Post => await httpClient.PostAsJsonAsync(url, requestEntity, cancellationToken),
                    _ => null
                };
